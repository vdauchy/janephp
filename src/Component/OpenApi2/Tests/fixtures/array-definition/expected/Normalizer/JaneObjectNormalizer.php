...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        use CheckArray;
        use ValidatorTrait;
        protected $normalizers = [\Jane\Component\OpenApi2\Tests\Expected\Model\BarItem::class => \Jane\Component\OpenApi2\Tests\Expected\Normalizer\BarItemNormalizer::class, \Jane\Component\JsonSchemaRuntime\Reference::class => \Jane\Component\OpenApi2\Tests\Expected\Runtime\Normalizer\ReferenceNormalizer::class], $normalizersCache = [];
        ...
        {
            return [\Jane\Component\OpenApi2\Tests\Expected\Model\BarItem::class => false, \Jane\Component\JsonSchemaRuntime\Reference::class => false];
        }
    }
} else {
    class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface

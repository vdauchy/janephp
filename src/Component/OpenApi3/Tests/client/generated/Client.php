...
class Client extends \Jane\Component\OpenApi3\Tests\Client\Runtime\Client\Client
{
    ...
    public static function create($httpClient = null, array $additionalPlugins = [])
    {
        ...
        $serializer = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Jane\Component\OpenApi3\Tests\Client\Normalizer\JaneObjectNormalizer()), [new \Symfony\Component\Serializer\Encoder\JsonEncoder(new \Symfony\Component\Serializer\Encoder\JsonEncode(), new \Symfony\Component\Serializer\Encoder\JsonDecode(['json_decode_associative' => true)))));
